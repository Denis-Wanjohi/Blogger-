    ...
    <!-- HEADER -->
        <nav class="bg-purple-700 flex justify-space-between sm:h-[70px] w-full">
            <div class=" sm:flex sm:items-baseline ml-5 m-auto">
                <span  class="text-5xl font-bold">Blogger</span>
                <br>
                <span class="text-sm ml-5 md:inline-block md:aling-baseline  italic">...where you get the updates</span>
            </div>
            <div class="flex  items-center my-auto h-3/4 sm:mr-10 mr-5">
                <div class="flex rounded-5xl hidden sm:block">
                    <input type="text" placeholder="search..."  class="pl-1 outline-none border-0 border-b-black border-b-2 rounded focus:border-b-purple-900 max-h-8">
                </div>
        ...
        <nav :class="[menuVisibility ? 'block': 'hidden' ]">
            ...
            <div class="border shadow-xl w-[250px] mr-4 absolute right-0 rounded-t-md">
                    <span class="absolute right-0 cursor-pointer" @click="menu">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24"><path fill="black" d="m8.4 17l3.6-3.6l3.6 3.6l1.4-1.4l-3.6-3.6L17 8.4L15.6 7L12 10.6L8.4 7L7 8.4l3.6 3.6L7 15.6zm3.6 5q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22m0-2q3.35 0 5.675-2.325T20 12q0-3.35-2.325-5.675T12 4Q8.65 4 6.325 6.325T4 12q0 3.35 2.325 5.675T12 20m0-8"/></svg>
                    </span>
                    ...
                    <div class="flex rounded-5xl justify-between mx-auto sm:hidden">
                        <input type="text" placeholder="search..."  class="w-full pl-1 outline-none border-0 border-b-black border-b-2 rounded focus:border-b-purple-900 max-h-8">
                        <p class="bg-green-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24"><path fill="black" d="m19.6 21l-6.3-6.3q-.75.6-1.725.95T9.5 16q-2.725 0-4.612-1.888T3 9.5q0-2.725 1.888-4.612T9.5 3q2.725 0 4.613 1.888T16 9.5q0 1.1-.35 2.075T14.7 13.3l6.3 6.3zM9.5 14q1.875 0 3.188-1.312T14 9.5q0-1.875-1.312-3.187T9.5 5Q7.625 5 6.313 6.313T5 9.5q0 1.875 1.313 3.188T9.5 14"/></svg>
                        </p>
                    </div>
