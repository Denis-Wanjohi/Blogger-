...
<template>
  ...
  <nav :class="[menuVisibility ? 'block': 'hidden' ]">
    <div class="border bg-gray-100 shadow-xl w-[250px] mr-4 absolute right-0 rounded-t-md z-10">
      ...
      <p class="text-2xl font-bold tracing-wide text-left pl-5 pt-5 sm:hidden block">Categories</p>
  ...
  <!-- CONTENTS -->
        <div class="flex">
            ...
            <div class="w-full h-screen overflow-y-auto" style="scrollbar-color: white white;">
                <section class="text-center flex justify-between text-2xl font-thin border sticky top-0 bg-gray-800 border-black text-white w-full">
                    ...
                    <div class="w-full hover:bg-orange-200">
                        EVENTS
                    </div>
                </section>
