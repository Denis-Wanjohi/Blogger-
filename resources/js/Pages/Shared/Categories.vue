...
<template>
    <section>
        ...
        >
            ...
            <ul>
                <Link :href="$page.url + 'science'" class="border border-b-green-700 pl-3 my-4 pb-2 flex items-center">
                ...
                <li class="border border-b-green-700 pl-3 my-4 pb-2 flex">
                ...
                <li class="border border-b-green-700 pl-3 my-4 pb-2 flex">
                    ...
                    <p class="pl-3" :class="[CategoriesResize?'block':'hidden']">Bussiness</p>
                </li>
                <li class="border border-b-green-700 pl-3 my-4 pb-2 flex ">
