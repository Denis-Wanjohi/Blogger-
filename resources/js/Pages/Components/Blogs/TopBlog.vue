<template>
   <section class="h-3/4 pb-2">
        <div class="w-[90%] mt-10  h-1/2 mx-auto">
            ...
            <div class="sm:flex flex flex-col-reverse sm:flex-row mt-3 ">
                    <div class="bg-orange-100 w-full max-h-[400px] ">
                        <p class="text-4xl font-bold text-center my-1 pb-1 border-b-black border-b-2">Hot news</p>
                        <p class="text-2xl font-bold text-center my-1 pb-1   w-3/4 mx-auto">Kenya's Safari on HEAT</p>
                        ...
                        <p class="text-end italic pr-2 text-xs">at 14:01:00 13.02.2024</p>
                        <p class="text-sm text-end italic font-bold pr-2">~Kim Kimani</p>
